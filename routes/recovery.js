 ...
 *     responses: { 200: { description: Complaint types } }
 *   post:
 ...
 *     responses: { 200: { description: Created }, 400: { description: Duplicate/validation } }
 */
 ...
 *         name: rating
 *         schema: { type: integer }
 *     responses: { 200: { description: Paginated feedback } }
 */
 ...
 *     responses: { 200: { description: Paginated complaint cases } }
 */
 ...
 *     security: [{ bearerAuth: [] }]
 *     parameters: [{ in: path, name: id, required: true, schema: { type: string } }]
 *     responses: { 200: { description: Complaint case } }
 */
 ...
 *               note: { type: string }
 *     responses: { 200: { description: Transitioned }, 400: { description: Illegal transition } }
 */
 ...
 *               note: { type: string }
 *     responses: { 200: { description: Action added } }
 */
 ...
 *     responses: { 200: { description: Credit requested (pending approval) } }
 */
 ...
 *     parameters: [{ in: path, name: id, required: true, schema: { type: string } }]
 *     responses:
 *       200: { description: Approved and credited }
 *       400: { description: Above threshold without admin approval, or nothing pending }
 */
 ...
 *     security: [{ bearerAuth: [] }]
 *     parameters: [{ in: path, name: id, required: true, schema: { type: string } }]
 *     responses: { 200: { description: Messages (marks read for staff) } }
 *   post:
