...
const {
  ...
  ROUTE_SORT_AND_PRETREAT_REGISTER,
  ROUTE_SORT_AND_PRETREAT_GOOGLE_SIGNUP,
  ROUTE_SORT_AND_PRETREAT_APPLE_SIGNUP,
  ROUTE_SORT_AND_PRETREAT_LOGIN,
  ROUTE_SORT_AND_PRETREAT_FORGOT_PASSWORD,
  ROUTE_SORT_AND_PRETREAT_VERIFY_RESET_PASSWORD_OTP,
  ROUTE_SORT_AND_PRETREAT_RESET_PASSWORD,
...
/**
 * @swagger
 * /auth/sort-pretreat/register:
 *   post:
 *     summary: Register a new sort-and-pretreat user
 *     tags:
 *       - AuthSortAndPretreat
 *     requestBody:
 *       required: true
 ...
 *         description: Internal server error
 */
router.post(ROUTE_SORT_AND_PRETREAT_REGISTER, (req, res) => {
  const controller = new UserController();
  return controller.createSortAndPretreatUser(req, res);
});

/**
 * @swagger
 * /auth/sort-pretreat/google-signup:
 *   post:
 *     summary: Register new sort-and-pretreat user through Google
 *     tags:
 *       - AuthSortAndPretreat
 *     requestBody:
 *       required: true
 ...
 *         description: Server error
 */
router.post(ROUTE_SORT_AND_PRETREAT_GOOGLE_SIGNUP, (req, res) => {
  const controller = new UserController();
  return controller.googleSortAndPretreatSignup(req, res);
});

/**
 * @swagger
 * /auth/sort-pretreat/apple-signup:
 *   post:
 *     summary: Register new sort-and-pretreat user through Apple
 *     tags:
 *       - AuthSortAndPretreat
 *     requestBody:
 *       required: true
 ...
 *         description: Server error
 */
router.post(ROUTE_SORT_AND_PRETREAT_APPLE_SIGNUP, (req, res) => {
  const controller = new UserController();
  return controller.appleSortAndPretreatSignup(req, res);
});

/**
 * @swagger
 * /auth/sort-pretreat/login:
 *   post:
 *     summary: Login a sort-and-pretreat user
 *     tags:
 *       - AuthSortAndPretreat
 *     requestBody:
 *       required: true
 ...
 *         description: Invalid credentials
 */
router.post(ROUTE_SORT_AND_PRETREAT_LOGIN, (req, res) => {
  const controller = new UserController();
  return controller.loginSortAndPretreatUser(req, res);
});

/**
 * @swagger
 * /auth/sort-pretreat/forgot-password:
 *   post:
 *     summary: Send password reset email
 *     tags:
 *       - AuthSortAndPretreat
 ...
 *         description: Server error
 */
router.post(ROUTE_SORT_AND_PRETREAT_FORGOT_PASSWORD, (req, res) => {
  const controller = new UserController();
  return controller.forgotSortAndPretreatPassword(req, res);
});

/**
 * @swagger
 * /auth/sort-pretreat/verify-reset-password-otp:
 *   post:
 *     summary: Verify OTP for password reset
 *     description: Verifies the OTP sent to the user's email and returns a short-lived reset token.
 *     tags:
 ...
 *         description: Server error
 */
router.post(ROUTE_SORT_AND_PRETREAT_VERIFY_RESET_PASSWORD_OTP, (req, res) => {
  const controller = new UserController();
  return controller.verifySortAndPretreatResetPasswordOtp(req, res);
});

/**
 * @swagger
 * /auth/sort-pretreat/reset-password:
 *   post:
 *     summary: Reset user password
 *     description: Resets the user's password using a valid reset token obtained after OTP verification.
 *     tags:
 ...
 *         description: Server error
 */
router.post(ROUTE_SORT_AND_PRETREAT_RESET_PASSWORD, (req, res) => {
  const controller = new UserController();
  return controller.resetSortAndPretreatPassword(req, res);
});

/**
 * @swagger
 * /auth/sort-pretreat/verify-otp:
 *   post:
 *     summary: Verify OTP
 *     tags:
 *       - AuthSortAndPretreat
 ...
 *         description: Server error
 */
router.post(ROUTE_SORT_AND_PRETREAT_VERIFY_OTP, (req, res) => {
  const controller = new UserController();
  return controller.verifySortAndPretreatOTP(req, res);
});

/**
 * @swagger
 * /auth/sort-pretreat/resend-otp:
 *   post:
 *     summary: Resend OTP to user email/phone
 *     tags:
 *       - AuthSortAndPretreat
 ...
 *         description: Server error
 */
router.post(ROUTE_SORT_AND_PRETREAT_RESEND_OTP, (req, res) => {
  const controller = new UserController();
  return controller.resendSortAndPretreatOtp(req, res);
});

/**
 * @swagger
 * /auth/sort-pretreat/verify-email:
 *   post:
 ...
 *         description: Server error
 */
router.post(ROUTE_SORT_AND_PRETREAT_VERIFY_EMAIL, (req, res) => {
  const controller = new UserController();
  return controller.verifySortAndPretreatEmail(req, res);
});

/**
 * @swagger
 * /auth/sort-pretreat/refresh-token:
 *   post:
 *     summary: Refresh Access Token
 *     tags:
 *       - AuthSortAndPretreat
 ...
 *         description: Invalid or expired refresh token
 */
router.post(ROUTE_SORT_AND_PRETREAT_REFRESH_TOKEN, (req, res) => {
  const controller = new UserController();
  return controller.refreshSortAndPretreatToken(req, res);
});
