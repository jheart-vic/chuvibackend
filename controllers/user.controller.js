...
class UserController extends BaseController {
    async getDashboard(req, res) {
        ...
        const result = await userService.getDashboard(req)
        if (!result.success) {
    ...
    async updateUserProfile(req, res) {
        ...
        if (!updateUserProfile.success) {
            return BaseController.sendFailedResponse(
                res,
    ...
    async getUserNotifications(req, res) {
        const userService = new UserService()
        const getUserNotifications = await userService.getUserNotifications(
            req,
            res,
        )
    ...
    async resetPasswordInProfilePage(req, res) {
        const userService = new UserService()
        const resetPassword = await userService.resetPasswordInProfilePage(
            req,
            res,
        )
