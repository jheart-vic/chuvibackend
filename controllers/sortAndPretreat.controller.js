...
class SortAndPretreatController extends BaseController {
    ...
    async undoMarkItemAsPretreated(req, res) {
        const result =
            await SortAndPretreatService.undoMarkItemAsPretreated(req)
        return result.success
            ? BaseController.sendSuccessResponse(res, result.data)
            : BaseController.sendFailedResponse(res, result.data)
    }
    ...
    async getFlaggedOrderDetail(req, res) {
        const result = await SortAndPretreatService.getFlaggedOrderDetail(req)
        return result.success
            ? BaseController.sendSuccessResponse(res, result.data)
            : BaseController.sendFailedResponse(res, result.data)
    }
    ...
    async getSortedAndPretreatdOrders(req, res) {
        const result =
            await SortAndPretreatService.getSortedAndPretreatdOrders(req)
        return result.success
            ? BaseController.sendSuccessResponse(res, result.data)
            : BaseController.sendFailedResponse(res, result.data)
    }

    async getSortedOrderDetail(req, res) {
        const result = await SortAndPretreatService.getSortedOrderDetail(req)
        return result.success
            ? BaseController.sendSuccessResponse(res, result.data)
            : BaseController.sendFailedResponse(res, result.data)
    }
