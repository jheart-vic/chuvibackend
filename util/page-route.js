...
exports.ROUTE_SORT_AND_PRETREAT_ORDER_QUEUE = "/sort-pretreat/orders/queue";
exports.ROUTE_SORT_AND_PRETREAT_SINGLE_ORDER = "/sort-pretreat/order/:id";
exports.ROUTE_SORT_AND_PRETREAT_UPDATE_ITEM = "/sort-pretreat/order/:id/items/:itemId/sort-details";
exports.ROUTE_SORT_AND_PRETREAT_MARK_ITEM_SORTED = "/sort-pretreat/order/:id/items/:itemId/mark-sorted";
exports.ROUTE_SORT_AND_PRETREAT_UNMARK_SORTED_ITEM = "/sort-pretreat/order/:id/items/:itemId/undo-sorted";
exports.ROUTE_SORT_AND_PRETREAT_MARK_ALL_AS_SORTED = "/sort-pretreat/order/:id/mark-all-sorted";
exports.ROUTE_SORT_AND_PRETREAT_MARK_AS_PRETREATED = "/sort-pretreat/order/:id/items/:itemId/mark-pretreated";
exports.ROUTE_SORT_AND_PRETREAT_MARK_UNDO_PRETREATED = "/sort-pretreat/order/:id/items/:itemId/undo-pretreated";
exports.ROUTE_SORT_AND_PRETREAT_MARK_AS_FLAGGED = "/sort-pretreat/order/:id/items/:itemId/flag";
exports.ROUTE_SORT_AND_PRETREAT_NEXT_STAGE = "/sort-pretreat/order/:id/send-to-next-stage";
exports.ROUTE_SORT_AND_PRETREAT_GET_FLAGGED = "/sort-pretreat/orders/flagged";
exports.ROUTE_SORT_AND_PRETREAT_GET_COMPLETED = "/sort-pretreat/orders/completed";
exports.ROUTE_SORT_AND_PRETREAT_WASHING = "/sort-pretreat/orders/washing";
exports.ROUTE_SORT_AND_PRETREAT_WASHING_SINGLE = "/sort-pretreat/order/washing/:id";
exports.ROUTE_SORT_AND_PRETREAT_IRONING = "/sort-pretreat/orders/ironing";
exports.ROUTE_SORT_AND_PRETREAT_IRONING_SINGLE = "/sort-pretreat/order/ironing/:id";
exports.ROUTE_SORT_AND_PRETREAT_HISTORY = "/sort-pretreat/orders/history";
exports.ROUTE_SORT_AND_PRETREAT_HISTORY_TIMELINE = "/sort-pretreat/order/history/:id/timeline";

// wash and dry
exports.ROUTE_WASH_AND_DRY_UNMARK_DASHBOARD = "/wash-dry/dashboard";
exports.ROUTE_WASH_AND_DRY_QUEUE = "/wash-dry/orders/queue";
exports.ROUTE_WASH_AND_DRY_QUEUE_SINGLE = "/wash-dry/order/queue/:id";
exports.ROUTE_WASH_AND_DRY_CONFIRM_FOR_WASHING = "/wash-dry/order/queue/:id/items/:itemId/confirm-washing";
exports.ROUTE_WASH_AND_DRY_UNDO_CONFIRM_FOR_WASHING = "/wash-dry/order/queue/:id/items/:itemId/undo-washing";
exports.ROUTE_WASH_AND_DRY_HOLD = "/wash-dry/order/queue/:id/items/:itemId/hold";
exports.ROUTE_WASH_AND_DRY_GET_ACTIVE_WASHING = "/wash-dry/orders/active-wash";
exports.ROUTE_WASH_AND_DRY_MOVE_TO_DRYING = "/wash-dry/order/active-wash/:id/move-to-drying";
exports.ROUTE_WASH_AND_ACTIVE_DRYING = "/wash-dry/orders/active-dry";
exports.ROUTE_WASH_AND_DRY_MARK_COMPLETE = "/wash-dry/order/active-dry/:id/complete";
exports.ROUTE_WASH_AND_DRY_GET_HOLD = "/wash-dry/orders/hold";
exports.ROUTE_WASH_AND_DRY_RELEASE = "/wash-dry/order/hold/:id/release";
exports.ROUTE_WASH_AND_DRY_HISTORY = "/wash-dry/orders/history";
exports.ROUTE_WASH_AND_DRY_HISTORY_TIMELINE = "/wash-dry/order/history/:id/timeline";

// press and iron

// press and iron
exports.ROUTE_PRESS_IRON_DASHBOARD               = '/press-iron/dashboard'
exports.ROUTE_PRESS_IRON_QUEUE                   = '/press-iron/orders/queue'
exports.ROUTE_PRESS_IRON_QUEUE_SINGLE            = '/press-iron/order/queue/:id'
exports.ROUTE_PRESS_IRON_CONFIRM_FOR_PRESSING    = '/press-iron/order/queue/:id/items/:itemId/confirm-pressing'
exports.ROUTE_PRESS_IRON_UNDO_CONFIRM_FOR_PRESSING = '/press-iron/order/queue/:id/items/:itemId/undo-pressing'
exports.ROUTE_PRESS_IRON_HOLD                    = '/press-iron/order/queue/:id/items/:itemId/hold'
exports.ROUTE_PRESS_IRON_GET_ACTIVE_PRESS        = '/press-iron/orders/active-press'
exports.ROUTE_PRESS_IRON_PRESS_DONE              = '/press-iron/order/active-press/:id/complete'
exports.ROUTE_PRESS_IRON_GET_HOLD                = '/press-iron/orders/hold'
exports.ROUTE_PRESS_IRON_RELEASE                 = '/press-iron/order/hold/:id/release'
exports.ROUTE_PRESS_IRON_HISTORY                 = '/press-iron/orders/history'
exports.ROUTE_PRESS_IRON_HISTORY_TIMELINE        = '/press-iron/order/history/:id/timeline'
