...
exports.ROUTE_PROFILE_IMAGE_DELETE = '/profile-image'
...
exports.ROUTE_ACTIVE_QC_QUEUE                  = '/orders/active-queue'
exports.ROUTE_QC_QUEUE_SINGLE           = '/order/queue/:id'
exports.ROUTE_QC_CONFIRM_ITEM           = '/order/queue/:id/items/confirm'
exports.ROUTE_QC_UNDO_CONFIRM_ITEM                  = '/order/queue/:id/items/undo-confirm'
...
exports.ROUTE_WASH_AND_DRY_CONFIRM_FOR_WASHING = "/order/queue/:id/items/confirm-washing";
exports.ROUTE_WASH_AND_DRY_UNDO_CONFIRM_FOR_WASHING  = '/order/queue/:id/items/undo-washing'
...
exports.ROUTE_PRESS_IRON_CONFIRM_FOR_PRESSING    = '/order/queue/:id/items/confirm-pressing'
exports.ROUTE_PRESS_IRON_UNDO_CONFIRM_FOR_PRESSING   = '/order/queue/:id/items/undo-pressing'
...
exports.ROUTE_UPDATE_ORDER_DETAILS = '/update-order-details'
exports.ROUTE_GET_ADMIN_SETTING = '/get-admin-setting'
...
exports.ROUTE_DISPATCH_TAG = '/order/:id/dispatch-tag'
exports.ROUTE_DISPATCH_TAG_PRINT = '/order/:id/dispatch-tag/print'
...
exports.ROUTE_OFFER_ADMIN_CUSTOMER_OFFERS = "/admin/customer-offers"
...
exports.ROUTE_BOT_CUSTOMER_REPLY = "/conversation/:conversationId/message"
...
exports.ROUTE_RIDER_ASSIGNED_PICKUPS     = '/assigned-pickups'
exports.ROUTE_RIDER_ACTIVE_PICKUPS       = '/active-pickups'
exports.ROUTE_RIDER_START_PICKUP_ID         = '/start-pickup/:id'
exports.ROUTE_RIDER_MARK_PICKUP_ID         = '/mark-pickup/:id'
...
//CRM
exports.ROUTE_CRM_CUSTOMERS            = '/customers'
exports.ROUTE_CRM_CUSTOMER_CARD        = '/customers/:id'
exports.ROUTE_CRM_ADD_TAG              = '/customers/:id/tags'
exports.ROUTE_CRM_REMOVE_TAG           = '/customers/:id/tags/:tag'
exports.ROUTE_CRM_CORRECT_STAGE        = '/customers/:id/stage'
exports.ROUTE_CRM_CREATE_WALKIN_LEAD   = '/leads'
exports.ROUTE_CRM_UPDATE_FOLLOWUP      = '/followups/:id'
exports.ROUTE_CRM_METRICS              = '/metrics'
exports.ROUTE_CRM_REPORT_MONTHLY_LEADS = '/reports/monthly-leads'
